...
<table width="600" border="0" cellpadding="0" cellspacing="0" bgcolor="#fff" style="margin:0 auto">
  <tr>
    <td width="50px">&nbsp;</td>
    <td><a href="<?php echo WWW_BASE.'#popup_box'?>" style="float:left; margin:30px 0 20px;">
	<img src="http://braintechnosys.net/cmyco/img/logo.png" width="100" height="82" alt="CMYCO" />
	</a></td>
    <td width="50px">&nbsp;</td>
  </tr>
	  ...
	  <tr>
    <td>&nbsp;</td>
    <td align="left" style="padding:10px 0;">&nbsp;	</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
