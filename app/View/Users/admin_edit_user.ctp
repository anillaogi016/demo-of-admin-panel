<?php echo $this->Form->create('User', array('novalidate' => true, 'url'=>array('controller'=>'users','action'=>'admin_edit_user'),'id'=>'categoryadd'));
?>
<script>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="change-password form_section">
				...
				<!--<tr>
					...
					<td>
						...
						//echo $this->Form->input('email',array('type'=>'text','class' => 'form-control','label'=>false)); ?>
						<div class="clr10"></div>
					</td>
				</tr>-->
				<tr>
					...
					<td>
						<?php 
						echo $this->Form->hidden('id');
						echo $this->Form->input('mobile',array('type'=>'text','class' => 'form-control','label'=>false)); ?>
						<div class="clr10"></div>
					</td>
				</tr>
				<tr>
