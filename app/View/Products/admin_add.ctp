<?php echo $this->Form->create('Product', array('novalidate' => true, 'url'=>array('controller'=>'products','action'=>'admin_add'),'enctype'=>'multipart/form-data','id'=>'productadd'));
?>
		...
		<td align="center">
			<table cellpadding="0" cellspacing="0" border="0" class="change-password form_section">
				...
				<tr>
					...
					<td>
						<?php echo $this->Form->input('state_id',array('type'=>'select', 'empty' => 'Select one' ,'options' => $allState ,'class' => 'required form-control stateSelect','id'=>'stateSelect','label'=>false)); ?>
						<div class="clr10"></div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<?php echo $this->Form->input('city_id',array('type'=>'select', 'empty' => 'Select one' ,'class' => 'required form-control cityselect','id'=>'cityselect','label'=>false)); ?>
						<div class="clr10"></div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<?php echo $this->Form->input('subcat_id',array('type'=>'select', 'empty' => 'Select one' ,'class' => 'required form-control subcategoryselect','id'=>'subcategoryselect','label'=>false)); ?>
						<div class="clr10"></div>
					</td>
				</tr>
				<tr>
