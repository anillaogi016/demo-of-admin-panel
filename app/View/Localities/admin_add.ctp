...
echo $this->Form->create('Locality', array('novalidate' => true, 'url'=>array('controller'=>'localities','action'=>'admin_add'),'id'=>'subsubcategory'));
?>
		...
		<td align="center">
			<table cellpadding="0" cellspacing="0" border="0" class="change-password form_section">
				...
				<tr>
					...
					<td>
						<?php echo $this->Form->input('state_id',array('type'=>'select', 'empty' => 'Select one' ,'options' => $allState , 'selected' => $val, 'class' => 'form-control categorySelect','id'=>'categorySelect','label'=>false)); ?>
						<div class="clr10"></div>
					</td>
				</tr>
