<?php echo $this->Form->create('City', array('novalidate' => true, 'url'=>array('controller'=>'cities','action'=>'admin_add'),'id'=>'subcategory'));
?>
	...
	<tr>
		<td align="center">
			<table cellpadding="0" cellspacing="0" border="0" class="change-password form_section">
				...
				<tr>
				   <td></td>
				   <td><button  class="btn-common" type="submit"  >Save</button>&nbsp;<a style="text-decoration:none" class="btn-common" href=" <?php echo WWW_BASE_ADMIN;?>/cities/list ">Cancel </a>
