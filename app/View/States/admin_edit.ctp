<?php echo $this->Form->create('State', array('novalidate' => true, 'url'=>array('controller'=>'states','action'=>'admin_edit'),'id'=>'categoryadd'));
?>
<script>
		...
		<td align="center">
			<table cellpadding="0" cellspacing="0" border="0" class="change-password form_section">
				...
				<tr>
				   ...
				   &nbsp;<a style="text-decoration:none" class="btn-common" href=" <?php echo WWW_BASE_ADMIN;?>/states/list ">Cancel </a>
